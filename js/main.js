(function($) {
    ...
    if ($.fn.meanmenu) {
        $("nav#dropdown").meanmenu({
            siteLogo: "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='index-new.html'><img src='images/logo-main.jpg' alt='logo' class='img-fluid' width='60px'/></a></div>",
        });
    }
